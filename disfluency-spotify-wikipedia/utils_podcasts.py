...
def write_transformed_files_out(INPUT_LIST=["spotify"]):
    print("writing flattened files out...")
    
    rng = np.random.default_rng(seed=0)
    
    for i in INPUT_LIST:
        print("writing input:", i)
        current_input_dir = os.path.join(utils_general.PATH_TO_PROJECT, i)
...
def write_original_files_out(directory):
    ...
    out_dir = os.path.join(utils_general.PATH_TO_PROJECT, "spotify")
